def lstm_model():
	...
	Original file is located at
		https://colab.research.google.com/drive/1sePcmDnm7-LY8Fpv1_-IDQeYEJKYif0X
	...
	StockData = pd.read_csv(os.path.join('./app/analysis/historical_data','ccc.csv'),
	...
	regressor.save( os.path.join('./app/analysis/models','ccc_lstm_model.h5') )
	...
	# Saving the model to file
	regressor.save(os.path.join('./app/analysis/models','ccc_multi_lstm_model.h5'))
